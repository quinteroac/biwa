...
export async function newGame(gameId?: string, title?: string): Promise<void> {
  if (!gameId) {
    console.error('Usage: bun manager/cli.ts new <gameId> [title]')
    console.error('Example: bun manager/cli.ts new midnight-cafe "The Midnight Cafe"')
    process.exit(1)
  }

  if (!/^[a-z0-9][a-z0-9-]*$/.test(gameId)) {
    console.error(`Invalid gameId "${gameId}". Use lowercase letters, numbers and hyphens, for example "midnight-cafe".`)
    process.exit(1)
  }
...
`)
  ...
  console.log(`  ✓ games/${gameId}/data/scenes/default.md`)
  console.log(`  ✓ games/${gameId}/assets/scenes/default/background.svg`)
  console.log(`  ✓ games/${gameId}/data/characters/`)
  console.log(`  ✓ games/${gameId}/data/audio/bgm/`)
  console.log(`  ✓ games/${gameId}/data/audio/sfx/`)
  console.log(`  ✓ games/${gameId}/data/audio/ambience/`)
  console.log(`  ✓ games/${gameId}/data/audio/voice/`)
  console.log(`  ✓ games/${gameId}/data/minigames/`)
  console.log(`  ✓ games/${gameId}/assets/characters/`)
  console.log(`  ✓ games/${gameId}/assets/audio/`)
